...
from ..M3.m3_config import NODE_TYPES, EDGE_TYPES
...
class MetamodelGraphResponse(BaseModel):
    ...
    edgeConstraints: List[EdgeType] = Field(default_factory=list, description="Edge type constraints from M3 configuration")
