...
export function RepositoryDetails() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(error?.message || error?.detail || "Erreur lors de la création");
    } finally {
      setLoading(false);
    }
  };
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col-reverse md:flex-row gap-3">
              <Button type="button" variant="outline" onClick={() => navigate("/repositories")} disabled={loading} className="w-full md:w-1/2">
                Annuler
              </Button>
