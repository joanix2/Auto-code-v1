      ...
      <main className="container px-4 py-8 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-4 mb-8">
          ...
          <div className="flex gap-3 items-center">
            ...
            {/* GitHub Sync Button */}
            {repository && (
              <Button variant="outline" onClick={() => setSyncDialogOpen(true)} className="flex items-center gap-2">
                  ...
                  {filteredTickets.map((ticket) => (
                    <SortableTicketCard
                      ...
                      onDevelopmentStarted={() => {
                        // Refresh tickets when development is started
                        fetchTickets();
                      }}
                    />
                  ))}
