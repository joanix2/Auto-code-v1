...
priority: P1
description: Mettre en place les tests frontend avec Vitest
---

## Description

Zero tests frontend dans le projet. Le frontend utilise Vite + React, Vitest est le choix naturel.
